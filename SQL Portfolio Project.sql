...
FROM '‪C:\Users\abhis\Downloads\Books.csv' 
CSV HEADER;

-- Import Data into Customers Table
COPY Customers(Customer_ID, Name, Email, Phone, City, Country) 
FROM '‪C:\Users\abhis\Downloads\Customers.csv' 
CSV HEADER;

-- Import Data into Orders Table
COPY Orders(Order_ID, Customer_ID, Book_ID, Order_Date, Quantity, Total_Amount) 
FROM '‪C:\Users\abhis\Downloads\Orders.csv' 
CSV HEADER;
--QUESTIONS-
...
SELECT b.Author,SUM(o.Quantity) AS Total_Sold from Books b JOIN orders o ON b.book_id=o.book_id
GROUP BY b.Author;
